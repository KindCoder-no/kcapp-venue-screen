import { CheckoutDart } from './kcapp';

type Modifier = 'single' | 'double' | 'triple';

interface SuggestionDart {
  modifier: Modifier;
  value: number;
}

const toCheckoutDart = (dart: SuggestionDart): CheckoutDart => ({
  value: dart.value,
  multiplier: dart.modifier === 'triple' ? 3 : dart.modifier === 'double' ? 2 : 1,
});

const getSuggestion = (score: number): SuggestionDart[] => {
  switch (score) {
    ...
    case 69: return [{ modifier: 'triple', value: 15 }, { modifier: 'double', value: 12 }];
    case 70: return [{ modifier: 'triple', value: 10 }, { modifier: 'double', value: 20 }];
    ...
    case 75: return [{ modifier: 'triple', value: 17 }, { modifier: 'double', value: 12 }];
    case 76: return [{ modifier: 'triple', value: 20 }, { modifier: 'double', value: 8 }];
    case 77: return [{ modifier: 'triple', value: 19 }, { modifier: 'double', value: 10 }];
    case 78: return [{ modifier: 'triple', value: 18 }, { modifier: 'double', value: 12 }];
    case 79: return [{ modifier: 'triple', value: 19 }, { modifier: 'double', value: 11 }];
    case 80: return [{ modifier: 'triple', value: 20 }, { modifier: 'double', value: 10 }];
    case 81: return [{ modifier: 'triple', value: 19 }, { modifier: 'double', value: 12 }];
    ...
    case 84: return [{ modifier: 'triple', value: 20 }, { modifier: 'double', value: 12 }];
    ...
    case 101: return [{ modifier: 'triple', value: 20 }, { modifier: 'single', value: 1 }, { modifier: 'double', value: 20 }];
    case 102: return [{ modifier: 'triple', value: 20 }, { modifier: 'single', value: 10 }, { modifier: 'double', value: 16 }];
    case 103: return [{ modifier: 'triple', value: 20 }, { modifier: 'single', value: 3 }, { modifier: 'double', value: 20 }];
    case 104: return [{ modifier: 'triple', value: 18 }, { modifier: 'single', value: 18 }, { modifier: 'double', value: 16 }];
    case 105: return [{ modifier: 'triple', value: 19 }, { modifier: 'single', value: 16 }, { modifier: 'double', value: 16 }];
    case 106: return [{ modifier: 'triple', value: 20 }, { modifier: 'single', value: 14 }, { modifier: 'double', value: 16 }];
    case 107: return [{ modifier: 'triple', value: 19 }, { modifier: 'single', value: 18 }, { modifier: 'double', value: 16 }];
    case 108: return [{ modifier: 'triple', value: 20 }, { modifier: 'single', value: 16 }, { modifier: 'double', value: 16 }];
    case 109: return [{ modifier: 'triple', value: 19 }, { modifier: 'single', value: 20 }, { modifier: 'double', value: 16 }];
    ...
    case 112: return [{ modifier: 'triple', value: 20 }, { modifier: 'single', value: 12 }, { modifier: 'double', value: 20 }];
    ...
    case 119: return [{ modifier: 'triple', value: 19 }, { modifier: 'triple', value: 10 }, { modifier: 'double', value: 16 }];
    case 120: return [{ modifier: 'triple', value: 20 }, { modifier: 'single', value: 20 }, { modifier: 'double', value: 20 }];
    case 121: return [{ modifier: 'triple', value: 17 }, { modifier: 'triple', value: 10 }, { modifier: 'double', value: 20 }];
    case 122: return [{ modifier: 'triple', value: 18 }, { modifier: 'triple', value: 20 }, { modifier: 'double', value: 4 }];
    case 123: return [{ modifier: 'triple', value: 19 }, { modifier: 'triple', value: 16 }, { modifier: 'double', value: 9 }];
    case 124: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 16 }, { modifier: 'double', value: 8 }];
    case 125: return [{ modifier: 'single', value: 25 }, { modifier: 'triple', value: 20 }, { modifier: 'double', value: 20 }];
    case 126: return [{ modifier: 'triple', value: 19 }, { modifier: 'triple', value: 19 }, { modifier: 'double', value: 6 }];
    case 127: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 17 }, { modifier: 'double', value: 8 }];
    case 128: return [{ modifier: 'triple', value: 18 }, { modifier: 'triple', value: 14 }, { modifier: 'double', value: 16 }];
    case 129: return [{ modifier: 'triple', value: 19 }, { modifier: 'triple', value: 16 }, { modifier: 'double', value: 12 }];
    case 130: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 20 }, { modifier: 'double', value: 5 }];
    ...
    case 135: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 17 }, { modifier: 'double', value: 12 }];
    case 136: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 20 }, { modifier: 'double', value: 8 }];
    case 137: return [{ modifier: 'triple', value: 19 }, { modifier: 'triple', value: 16 }, { modifier: 'double', value: 16 }];
    case 138: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 18 }, { modifier: 'double', value: 12 }];
    case 139: return [{ modifier: 'triple', value: 19 }, { modifier: 'triple', value: 14 }, { modifier: 'double', value: 20 }];
    case 140: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 16 }, { modifier: 'double', value: 16 }];
    case 141: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 19 }, { modifier: 'double', value: 12 }];
    ...
    case 148: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 16 }, { modifier: 'double', value: 20 }];
    ...
    case 157: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 19 }, { modifier: 'double', value: 20 }];
    ...
    case 164: return [{ modifier: 'triple', value: 20 }, { modifier: 'triple', value: 18 }, { modifier: 'double', value: 25 }];
...
const twoDartSuggestion = (score: number): SuggestionDart[] => {
  switch (score) {
    ...
    default: return getSuggestion(score);
  }
};

const oneDartSuggestion = (score: number): SuggestionDart[] => {
  return score === 50
    ? [{ modifier: 'double', value: 25 }]
    : getSuggestion(score);
};
...
export const getCheckoutSuggestions = (
  ...
  let suggestion: SuggestionDart[];

  switch (currentDart) {
    case 2:
      suggestion = twoDartSuggestion(score);
      break;
    case 3:
      suggestion = oneDartSuggestion(score);
      break;
    default:
  ...
  return suggestion.length > 0 ? [suggestion.map(toCheckoutDart)] : [];
};
